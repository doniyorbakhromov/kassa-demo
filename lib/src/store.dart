...
class AppStore extends ChangeNotifier {
  ...
  static const String _key = "kassa_demo_v1";
  ...
  Future<void> init() async {
    ...
    // Namoyish versiyasi: har ochilishda toza ma'lumot bilan boshlanadi.
    // Shunda saytga kirgan har bir odam to'liq va tartibli kassani ko'radi -
    // avvalgi mehmon menyuni o'chirib yoki parolni o'zgartirib qo'ygan
    // bo'lsa ham demo buzilmaydi.
    _seed();
    _persist();
  ...
  void _seed() {
    ...
    tables = <BarTable>[
      ...
      BarTable(id: newId(), name: "Peshtaxta 1", zone: "Peshtaxta", seats: 2),
      BarTable(id: newId(), name: "Peshtaxta 2", zone: "Peshtaxta", seats: 2),
    ];
