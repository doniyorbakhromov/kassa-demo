                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Namoyish versiyasi - parol ekranda ko'rsatiladi,
                          // shunda saytga kirgan har kim sinab ko'ra oladi.
                          Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 16,
                              vertical: 11,
                            ...
                            decoration: BoxDecoration(
                              color: Ink3.gold.withValues(alpha: 0.10),
                              borderRadius: BorderRadius.circular(14),
                              border: Border.all(
                                color: Ink3.gold.withValues(alpha: 0.30),
                              ),
                            ),
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
